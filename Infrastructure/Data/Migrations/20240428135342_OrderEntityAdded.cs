        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DelveryTime = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipToAddressFistName = table.Column<string>(name: "ShipToAddress_FistName", type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ItmeOrderedProductItemId = table.Column<int>(name: "ItmeOrdered_ProductItemId", type: "INTEGER", nullable: true),
                    ItmeOrderedProductName = table.Column<string>(name: "ItmeOrdered_ProductName", type: "TEXT", nullable: true),
                    ItmeOrderedPictureUrl = table.Column<string>(name: "ItmeOrdered_PictureUrl", type: "TEXT", nullable: true),
                    Price = table.Column<double>(type: "decimal(18,2)", nullable: false),
